...
export default function SetItem({ set, index, properties }: Props) {
  const setEditingExerciseItem = useSetRecoilState(createEditExerciseRecordAtom);
  return (
    <>
      <div
        ...
        <span
          color='#aaa'
          className="h-min col-span-2 text-xs font-bold flex items-center justify-center text-gray-200 mx-2"
        >
          <FontAwesomeIcon icon={EquipmentIcon[set.exercise.equipment]} className="w-4 h-4 mr-4" />
        </span>
        <div className="col-span-5 overflow-hidden flex flex-col items-stretch">
        ...
        <div className="col-span-3 flex text-right flex-col items-stretch">
