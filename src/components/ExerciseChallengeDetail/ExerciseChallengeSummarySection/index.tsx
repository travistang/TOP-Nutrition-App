import {
  challengeComparisonText,
  challengeConstraintText,
  createChallengeTypeText,
...
export default function ExerciseChallengeSummarySection({ challenge }: Props) {
  ...
  return (
    <div className="grid grid-cols-6 gap-2">
      ...
      >
        <div className="py-1">
          Complete the challenge by doing{" "}
          <b>
            {challengeComparisonText(mode)} {createChallengeTypeText(challenge)}
          </b>
          . This challenge resets <b>{interval.toString()}</b>.
          <br />
          <br />
          <p>
            {challengeConstraintText(exerciseConstraint)} are eligible for
