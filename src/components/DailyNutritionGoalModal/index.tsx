...
import { DailyNutritionGoal, dailyNutritionGoalAtom } from '../../atoms/DailyNutritionGoalAtom';
...
export default function DailyNutritionGoalModal() {
  const [{ modalOpened, targetNutritionIntake, targetCalories }, setDailyNutritionGoalAtom] = useRecoilState(dailyNutritionGoalAtom);
  ...
  const updatePlaceholderMarco = (marco: MarcoNutrition) => (value: string | number) => {
    ...
    <Modal onClose={onClose} opened={modalOpened} label="Daily nutrition goals">
      ...
      <TextInput
        type="number"
          ...
          value={nutritionGoalPlaceholder.targetCalories.toString()}
          ...
          />
      {
        Object.values(MarcoNutrition).map(marco => (
          <TextInput
            ...
            value={nutritionGoalPlaceholder.targetNutritionIntake[marco].toString()}
